...
public class Shell : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        //Once the particles have finsihed, destroy the game Object they are on
    ...
    private float CalculateDamage(Vector3 targetPosition)
    {
        ...
        //Calculate the proportion of the maximum distance (the explosionRadius) the traget is away
