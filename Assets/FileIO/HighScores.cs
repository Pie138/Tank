...
public class HighScores : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //To help us with tha, we'll print the current directory to the console
    ...
    {
        //Before we try to read a file, we should check that it exists. if it dosent exist, we'll log a message and abort.
        ...
        //Now we read the file in. We do this using a "StreamReader" , Which we give our full file path to. Dont forget the directory
        ...
        //A while loop, which runs as long as there is data to be read AND we havent reached the end of our scores array.
    ...
    public void AddScore(int newScore)
    {
        ...
        //If no desireed index was found then the score isnt high enough to get on the table, so we just abort
        if (desiredIndex < 0)
        {
